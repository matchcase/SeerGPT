...
import json
import re
from card_meanings import card_meanings

debug_flag = True if os.getenv("DEBUG") == "1" else False

def resource_path(relative_path):
    try:
        # When running as a PyInstaller bundle, _MEIPASS is set to the temporary folder path.
...
def load_images():
    folder_path = resource_path("assets/")
